...
<%--
End Of Line :: End your opponents line before they end yours
--%>
...
<head>
    ...
    <spring:url value="/resources/images/eol.png" var="eol"/>
    <link rel="shortcut icon" type="image/x-icon" href="${eol}">

    <title>End Of Line :: End your opponents line before they end yours</title>
